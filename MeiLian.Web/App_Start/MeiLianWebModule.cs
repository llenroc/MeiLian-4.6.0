...
using MeiLian.Web.App.Startup;//SPA!
using MeiLian.Web.Areas.Mpa.Startup;//MPA!
using MeiLian.Web.Bundling;
using MeiLian.Web.Navigation;
using MeiLian.Web.Routing;
using MeiLian.WebApi;
...
namespace MeiLian.Web
{
    ...
    [DependsOn(
        ...
        typeof(MeiLianDataModule),
        typeof(MeiLianApplicationModule),
        typeof(MeiLianWebApiModule),
    ...
    public class MeiLianWebModule : AbpModule
    {
