...
using MeiLian.Web.Areas.Mpa.Models.Layout;
using MeiLian.Web.Areas.Mpa.Startup;
using MeiLian.Web.Controllers;
using MeiLian.Web.Models.Layout;
using MeiLian.Web.Session;
using HeaderViewModel = MeiLian.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace MeiLian.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : MeiLianControllerBase
    {
